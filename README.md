...
The purpose of this project is to simulate a real industrial network where Engineering Workstations, SCADA systems, OT Security monitoring, and supporting infrastructure are deployed and managed using industry best practices.
Rather than focusing only on theoretical concepts, this repository demonstrates practical implementation, troubleshooting, documentation, and continuous improvements performed throughout the project.
